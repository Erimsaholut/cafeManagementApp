...
class MonthlyDataChart extends StatefulWidget {
  const MonthlyDataChart({super.key});

  @override
  State<MonthlyDataChart> createState() => _MonthlyDataChartState();
}

class _MonthlyDataChartState extends State<MonthlyDataChart> {
      ...
      titlesData: FlTitlesData(
        ...
        leftTitles: AxisTitles(
          sideTitles: SideTitles(
            showTitles: true,
            interval: 1,
            getTitlesWidget: leftTitleWidgets, /*soldaki yazılar*/
            reservedSize: 42,
          ),
        ),
      ),
